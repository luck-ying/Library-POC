...
class POC(POCBase):
    ...
    version = '1'  #默认为1
    author = ['']  #  PoC作者的大名
    vulDate = '2023-10-08'  #漏洞公开的时间,不知道就写今天
    createDate = '2023-10-08'  # 编写 PoC 的日期
    updateDate = '2023-10-08'  # PoC 更新的时间,默认和编写时间一样
    ...
    desc = '''
        fofa:深深信服下一代防火墙NGAF svpn_html/loadfile.php 存在任意文件读取漏洞 
    '''
  # 漏洞简要描述
